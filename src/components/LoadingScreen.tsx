  ...
  return (
    ...
    >
      <div className="relative overflow-hidden px-6 py-4">
        <div className="animate-logo-in flex flex-col items-center gap-4">
          <LogoMark className="h-28 w-auto" />
          <div className="text-[10px] uppercase tracking-[0.4em] text-white/60">
            Interioare premium · Satu Mare
          </div>
        </div>
        <div className="animate-sweep pointer-events-none absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent" />
      </div>
    </div>
  );
}
