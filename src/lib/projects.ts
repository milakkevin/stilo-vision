...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    services: ["Demolare și evacuare", "Structuri rigips", "Pardoseală decorativă", "Ancadramente și arcade", "Iluminat LED ambiental"],
    chips: ["Evoluție proiect", "Amenajare comercială", "Design premium", "Iluminat ambiental", "Proiect la cheie"],
  },
  {
